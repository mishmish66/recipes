...
\usepackage{multicol}
\usepackage{float}
\usepackage{nicefrac}  % Add this package
...
\begin{itemize}
    \item \nicefrac{1}{2} cup sunflower seed oil, plus more for greasing pan
    ...
    \item 2\nicefrac{1}{4} cups granulated sugar
    \item \nicefrac{1}{3} cup maple syrup or brown rice syrup
    ...
    \item \nicefrac{1}{4} teaspoon ground nutmeg
    \item \nicefrac{1}{4} teaspoon ground allspice
...
\begin{enumerate}
    ...
    \item Make the chocolate swirl: Transfer 1\nicefrac{1}{2} cups batter to another bowl. Add cocoa powder, remaining sugar and remaining rice milk, and whisk until smooth.
    
    \item Add cinnamon, nutmeg and allspice to batter in mixer and beat on low speed to incorporate.
    
    \item Pour batters into prepared Bundt pan in alternating layers, 1 cup pumpkin batter followed by \nicefrac{1}{2} cup chocolate batter. Repeat until you use up batters. Bake until a skewer inserted in cake comes out clean, about 1\nicefrac{1}{2} hours. Let cake cool in pan on a baking rack 20 minutes before removing.
...
\textit{Active Time: 40 minutes | Total Time: 2\nicefrac{1}{4} hours | Serves: 8-10}
